...
pub fn winrt_error_wrap<T: core::RuntimeType + 'static>(
...
pub fn winrt_none_error_wrap_with_error(
    result: core::Result<()>,
...
pub fn winrt_error_wrap_with_error<T: core::RuntimeType + 'static>(
    result: core::Result<T>,
    error: BluetoothError,
) -> crate::Result<T> {
    match result {
...
pub async fn winrt_async<T: core::RuntimeType + 'static>(
    result: core::Result<windows_future::IAsyncOperation<T>>,
) -> crate::Result<T> {
    match result {
...
pub async fn winrt_async_with_error<T: core::RuntimeType + 'static>(
    result: core::Result<windows_future::IAsyncOperation<T>>,
    error: BluetoothError,
) -> crate::Result<T> {
    match result {
...
pub async fn winrt_async_action(
    result: core::Result<windows_future::IAsyncAction>,
) -> crate::Result<()> {
    match result {
        Ok(op) => match op.await {
            Ok(_) => return Ok(()),
...
pub async fn winrt_async_action_with_error(
    result: core::Result<windows_future::IAsyncAction>,
    error: BluetoothError,
) -> crate::Result<()> {
    match result {
